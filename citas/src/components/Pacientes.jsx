    ...
    return (
        <div className='mt-5 shadow-xl bg-purple-200 p-8 rounded-md uppercase mb-3'>
            ...
            <div className="flex m-1 gap-5">
                ...
                <input type="button" value="Eliminar" onClick={handleEliminar} className='mt-2 border-2 border-purple-800 bg-purple-600 rounded-lg p-2 text-white hover:bg-purple-700 hover:cursor-pointer w-full' />
            </div>
        </div>
